...
if __name__ == '__main__':
    data = Compare("requirements_1.txt", "requirements_2.txt")
    data.get_status()
...
```python
-----------------------------------------------------------------------------------------------------
|           Package            |  requirements_env3.txt  |  requirements_env1.txt  |     Status     |
-----------------------------------------------------------------------------------------------------
|contourpy                     |1.0.6                    |1.0.7                    |Version Mismatch|
