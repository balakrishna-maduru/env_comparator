...
class TestCompare(unittest.TestCase):
    ...
    def test_compare_equal(self):
        ...
        self.assertEqual(compare.get_results(),self.read_json("resources/test_compare_equal.json"))

    def test_compare_version_diff(self):
        file1 = "resources/requirements_env1.txt"
        file2 = "resources/requirements_env2.txt"
        compare = Compare(file1,file2)
        self.assertEqual(compare.get_results(),self.read_json("resources/test_compare_equal_version_diff.json"))

    def test_compare_file1_diff(self):
        file1 = "resources/requirements_env1.txt"
        file2 = "resources/requirements_env3.txt"
        compare = Compare(file1,file2)
        self.assertEqual(compare.get_results(),self.read_json("resources/test_compare_equal_file1_diff.json"))

    def test_compare_file2_diff(self):
        file1 = "resources/requirements_env3.txt"
        file2 = "resources/requirements_env1.txt"
        compare = Compare(file1,file2)
        self.assertEqual(compare.get_results(),self.read_json("resources/test_compare_equal_file2_diff.json"))
